...
elseif s:style=='cool' 
  ...
  " I like real-black backgrounds - it's easier for me to see the contrasted
  " colors.  The original color is a dark grey but every thing looks muddy to
  " me.
  ...
  highlight Ignore		guifg=#404040	guibg=NONE
  " NOTE THIS IS IN THE COOL SECTION
  if v:version >= 700
    if has('spell')
