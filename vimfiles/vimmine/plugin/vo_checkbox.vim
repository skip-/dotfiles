...
map <buffer> ,,cb :call SafelyInsertCheckBox()<cr>
map <buffer> ,,c% :call SafelyInsertCheckBoxPercent()<cr>
map <buffer> ,,cB :call InsertCheckBox()<cr>

" delete a chechbox
"map <buffer> <localleader>cd :call DeleteCheckbox()<cr>
map <buffer> ,,cd :call DeleteCheckbox()<cr>

" switch the status of the box
"map <buffer> <localleader>cx :call SwitchBox()<cr>:call NewHMD(FindRootParent(line(".")))<cr>
map <buffer> ,,cx :call SwitchBox()<cr>:call NewHMD(FindRootParent(line(".")))<cr>

" calculate the proportion of work done on the subtree
"map <buffer> <localleader>cz :call NewHMD(line("."))<cr>
map <buffer> ,,cz :call NewHMD(line("."))<cr>
